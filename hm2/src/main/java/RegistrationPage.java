...
public class RegistrationPage {
            ...
            public void accountCreatingCustomerPhone (String phone) { driver.findElement(By.id("phone")).sendKeys(phone);}
            public void accountCreatingCustomerPhoneMobile (String phone_mobile) { driver.findElement(By.id("phone_mobile")).sendKeys(phone_mobile);}
